    ...
    def __call__(self, request):
        ...
        if auth_header and auth_header.startswith('Bearer '):
            ...
            try:
                ...
                # Se a assinatura for forjada ou o token expirado, cai no Exception
                # e o RLS rejeita as operações silenciosamente.
        ...
        if jwt_payload:
            ...
            with transaction.atomic():
                with connection.cursor() as cursor:
                    ...
                    cursor.execute("SELECT set_config('request.jwt.claims', %s, true);", [claims_json])
