...
class Todo(TimeStampedTenantModel):
    ...
    category = models.ForeignKey(TodoCategory, null=True, blank=True, on_delete=models.SET_NULL, db_column='category_id')
    ...
    created_by = models.ForeignKey(StaffMember, on_delete=models.RESTRICT, db_column='created_by_id', related_name='todos_created')
    # Para tarefas associadas a lojas/clientes
    related_store = models.ForeignKey(Store, null=True, blank=True, on_delete=models.CASCADE, db_column='related_store_id')
    related_client = models.ForeignKey(Client, null=True, blank=True, on_delete=models.CASCADE, db_column='related_client_id')
    ...
    class Meta:
        ...
        constraints = [
            models.CheckConstraint(
                condition=models.Q(due_date__isnull=True) | models.Q(due_date__gte=models.F('createdAt')),
...
class TodoAssignment(TimeStampedTenantModel):
    ...
    operator = models.ForeignKey(Operator, on_delete=models.CASCADE, db_column='operator_id')
    todo = models.ForeignKey(Todo, on_delete=models.CASCADE, db_column='todo_id', related_name='assignments')
    ...
    class Meta:
        ...
        constraints = [
            models.CheckConstraint(
                condition=(models.Q(assigned_to_staff__isnull=False) ^ models.Q(assigned_to_driver__isnull=False)),
