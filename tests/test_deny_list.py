...
class TestDenyListSignals:
    ...
    def test_driver_deactivation_triggers_denylist(self, mock_create_denylist, mock_filter, mock_redis):
    ...
    @patch.object(SecurityDenylist.objects, 'filter')
    @patch.object(SecurityDenylist.objects, 'create')
    def test_already_blocked_driver_skips_denylist_creation(self, mock_create, mock_filter, mock_redis):
