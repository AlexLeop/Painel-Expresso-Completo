...
const Corridas = React.lazy(() =>
  import("./pages/Corridas").then((m) => ({ default: m.Corridas })),
);
const Motoboys = React.lazy(() =>
  import("./pages/Motoboys").then((m) => ({ default: m.Motoboys })),
);
const Empresas = React.lazy(() =>
  import("./pages/Empresas").then((m) => ({ default: m.Empresas })),
);
const Escala = React.lazy(() =>
  import("./pages/Escala").then((m) => ({ default: m.Escala })),
);
const Lancamentos = React.lazy(() =>
