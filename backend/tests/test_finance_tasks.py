...
class TestFinanceTasks:
    ...
    def test_compute_daily_credit(
        self, operator, store, driver, contract_producao, completed_orders_week
    ):
        """
    ...
    def test_create_weekly_invoice_uses_single_mode(
        self, operator, store, driver, contract_garantido, completed_orders_week
    ):
        """
