              ...
              >
                ...
                <div className="space-y-4">
                  <h3 className="text-sm font-bold text-zinc-900 uppercase tracking-wider flex items-center gap-2 border-b border-zinc-100 pb-2">
                    ...
                    Informações da Loja Cliente
                  </h3>

                  <div>
                    <label className="block text-xs font-semibold text-zinc-700 mb-1">
                      Nome da Loja / Estabelecimento Parceiro
                    </label>
                    <input
                      type="text"
                      required
                      ...
                      placeholder="Ex: Pizzaria Bella, Burger King, Farmácia Centro..."
                    />
                  </div>
                    ...
                    <div>
                      ...
                      >
                        <option value="producao">
                          Produção (Diária + Taxas)
                        </option>
                        <option value="garantida">Garantida Mínima</option>
                        <option value="garantida_horas">
                          Garantida por Horas
                        </option>
                      </select>
                    </div>
                    ...
                    <div className="p-4 bg-amber-50/80 rounded-xl border border-amber-200/80 space-y-3">
                      <div>
                        ...
                        <p className="text-[10px] text-amber-700 font-medium">
                          Define o piso mínimo garantido por dia trabalhado. Se
                          a soma (Produção + Diária) ficar abaixo deste valor, o
                          sistema pagará o complemento.
                        </p>
                      </div>
                      <div className="grid grid-cols-2 gap-3">
                        <div>
                          <label className="block text-[10px] text-amber-800 mb-1 font-bold">
                            SEG-SEX R$
                          </label>
                          <input
                            type="number"
                      ...
                      <div className="flex items-center justify-between">
                        <div>
                          <label className="block text-[11px] font-black text-zinc-700 uppercase tracking-wider">
                            Garantia Mínima por Horas Trabalhadas
                          </label>
                          <p className="text-[10px] text-zinc-500 font-medium">
                            Define o garantido para cada turno independentemente
                            com base em sua duração (ex: 0 a 4h = R$ 110, 0 a 6h
                            = R$ 140).
                          </p>
                        </div>
                        <button
                        ...
                        {(formData.faixasHoras || []).filter(
                          ...
                          (formData.faixasHoras || [])
                            ...
                            .map((f) => (
                              <div
                                key={f.id}
                                className="grid grid-cols-12 gap-2 items-center bg-white p-2 rounded-lg border border-zinc-200 shadow-2xs transition-all"
                              >
                                <input
                                  ...
                                  onChange={(e) =>
                                    setFormData((prev) => ({
                                      ...prev,
                                      faixasHoras: prev.faixasHoras.map(
                                        (item) =>
                                          item.id === f.id
                                ...
                                <div className="col-span-2 relative">
                                  ...
                                  />
                                  <span className="absolute right-1 top-1/2 -translate-y-1/2 text-[9px] text-zinc-400 font-bold pointer-events-none hidden sm:inline">
                                    h
                                  </span>
                                </div>
                                <div className="col-span-2 relative">
                                ...
                                <button
                                  ...
                                  onClick={() =>
                                    setFormData((prev) => ({
                                      ...prev,
                                      faixasHoras: prev.faixasHoras.filter(
                                        (x) => x.id !== f.id,
                                      ),
                                    }))
                                  }
