...
export function DreTab() {
  ...
  return (
    <div className="space-y-6">
      {/* Header do DRE */}
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 p-5 bg-white border border-zinc-200 rounded-2xl shadow-xs">
        <div>
        ...
        <button
          onClick={fetchDre}
          disabled={loading}
          className="inline-flex items-center gap-2 px-3.5 py-2 text-xs font-semibold text-zinc-700 bg-zinc-50 border border-zinc-200 rounded-xl hover:bg-zinc-100 transition-colors self-start sm:self-auto cursor-pointer"
        >
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div className="p-5 bg-white border border-zinc-200 rounded-2xl shadow-xs space-y-3">
