      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 py-2">
        <div>
          ...
          <p className="text-[13px] font-medium text-zinc-500 mt-1 max-w-2xl">
            Gateway de integração, webhooks, proxy de despacho (Nola), e
            monitoramento de cron jobs e filas em tempo real.
          </p>
        </div>
          ...
          <div className="p-5 space-y-4">
            <div className="bg-zinc-900 text-zinc-300 p-4 rounded-lg font-mono text-[11px] overflow-x-auto shadow-inner border border-zinc-800">
              <div className="text-zinc-500 mb-2">
                // Último Payload Recebido (Validação HMAC OK)
              </div>
              <span className="text-emerald-400">POST</span>{" "}
              /api/webhooks/taxi-machine/status
              <br />
              <span className="text-zinc-500">{"{"}</span>
              <br />
              &nbsp;&nbsp;<span className="text-blue-300">"event"</span>:{" "}
              <span className="text-amber-300">"ride.status_updated"</span>,
              <br />
              &nbsp;&nbsp;<span className="text-blue-300">"ride_id"</span>:{" "}
              <span className="text-amber-300">"1459203"</span>,
              <br />
        ...
        <div className="glass-panel p-0 overflow-hidden flex flex-col">
          <div className="p-5 border-b border-zinc-100 flex items-center justify-between bg-zinc-50/50">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-[11px] font-medium text-zinc-500">
                  Ponte para parceiros enviarem pedidos
                </p>
              </div>
            </div>
          </div>
          <div className="p-5 space-y-4">
            <p className="text-[13px] text-zinc-600 leading-relaxed">
              Permite que sistemas parceiros despachem pedidos usando uma API
              simplificada. O backend traduz e injeta as credenciais de frota
              master automaticamente, mantendo a segurança (API Proxy).
            </p>
            <div className="space-y-3">
              <div className="flex justify-between items-center text-sm p-3 border border-zinc-200 rounded-lg">
                ...
                <button className="text-[11px] font-bold uppercase tracking-wider text-zinc-500 hover:text-zinc-900 transition-colors">
                  Revogar
                </button>
              </div>
            </div>
        ...
        <div className="glass-panel p-0 overflow-hidden flex flex-col lg:col-span-2">
          <div className="p-5 border-b border-zinc-100 flex items-center justify-between bg-zinc-50/50">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h2 className="text-sm font-bold text-zinc-900">
                  Rotinas de Automação de Fundo (Cron Jobs)
                </h2>
                <p className="text-[11px] font-medium text-zinc-500">
                  Processos assíncronos e retentativas (Retry Queues)
                </p>
              </div>
            </div>
          </div>
            ...
            <table className="w-full text-left border-collapse">
              ...
              <tbody className="text-sm divide-y divide-zinc-100">
                <tr className="hover:bg-zinc-50/50 transition-colors">
                  <td className="px-5 py-3.5">
                    <p className="font-semibold text-zinc-900 text-[13px]">
                      Limpeza de Faltas (Auto No-Show)
                    </p>
                    <p className="text-[11px] text-zinc-500 mt-0.5">
                      Marca ausência para motoristas confirmados que não
                      compareceram ao turno.
                    </p>
                  </td>
                  <td className="px-5 py-3.5 text-[12px] font-mono text-zinc-600">
                    A cada 15 min
                  </td>
                  <td className="px-5 py-3.5 text-[12px] font-medium text-zinc-600">
                    Hoje, 10:15
                  </td>
                ...
                <tr className="hover:bg-zinc-50/50 transition-colors">
                  <td className="px-5 py-3.5">
                    <p className="font-semibold text-zinc-900 text-[13px]">
                      Auto-Vinculação de Motoristas
                    </p>
                    <p className="text-[11px] text-zinc-500 mt-0.5">
                      Detecta corridas de novos motoristas no despacho e os
                      cadastra localmente.
                    </p>
                  </td>
                  <td className="px-5 py-3.5 text-[12px] font-mono text-zinc-600">
                ...
                <tr className="hover:bg-zinc-50/50 transition-colors">
                  <td className="px-5 py-3.5">
                    <p className="font-semibold text-zinc-900 text-[13px]">
                      Fila de Créditos e Retentativas
                    </p>
                    <p className="text-[11px] text-zinc-500 mt-0.5">
                      Processa créditos que falharam na API (Rate
                      Limit/Instabilidade) via Exponential Backoff.
                    </p>
                  </td>
                  <td className="px-5 py-3.5 text-[12px] font-mono text-zinc-600">
                    Contínuo
                  ...
                  <td className="px-5 py-3.5 text-[12px] font-medium text-zinc-600">
                    Em andamento (2 na fila)
                  </td>
                  <td className="px-5 py-3.5 text-center">
                    <span className="inline-flex items-center gap-1.5 px-2 py-0.5 rounded text-[10px] font-bold uppercase tracking-wider bg-amber-50 text-amber-600 border border-amber-200">
                      Processing
                    </span>
                  </td>
                </tr>
